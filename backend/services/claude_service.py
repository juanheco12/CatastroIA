...
def _demo_primera_propietario(data: SolicitudUnificada) -> str:
    ...
    p2 = (
        ...
        f"{data.numero_predial} y folio de matrícula inmobiliaria No. {data.folio_matricula}, "
        f"inscrito en la base de datos catastral del municipio de {mun}, "
...
def _demo_primera_autorizado(data: SolicitudUnificada) -> str:
    ...
    p2 = (
        ...
        f"del inmueble identificado con número predial {data.numero_predial} y folio de matrícula "
        f"inmobiliaria No. {data.folio_matricula}, inscrito en la base "
...
def _demo_primera_oficio(data: SolicitudUnificada) -> str:
    ...
    p2 = (
        ...
        f"del inmueble con número predial {data.numero_predial} y folio de matrícula inmobiliaria "
        f"No. {data.folio_matricula}, inscrito en la base de datos "
